                                                ...
                                                @if(count($newsletter)>0)
                                                    @foreach($newsletter as $data) 
                                                        <tr>   
                                                            ...
                                                            <td>
                                                            <a href='javascript:void(0);' data-href="{{ route('newsletter-delete',$data->id) }}" rel='tooltip' class="btn btn-danger btn-sm delete" title="Delete"><i class="fa fa-trash"></i></a>
                                                             </td>
                                                        </tr>
                                                    @endforeach
                                                @endif
