                                ...
                                <div class="card-header">
                                    <div class="form-row">
                                        <div class="col-md-12 text-right">
                                            <div class="col-md-12 text-right"><a href="{{route('homepagereport-create')}}" class="btn btn-success"><i class="align-middle" data-feather="plus"></i>{{__('Add')}}</a></div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                @if(count($homepagereports)>0)
                                                    @foreach($homepagereports as $data) 
                                                        <tr>   
                                                            ...
                                                            <td><a href="{{ route('homepagereport-edit',$data->id) }}" rel='tooltip' class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></a>
