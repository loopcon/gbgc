        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class=" breadcrumb breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('homepagereport')}}">Homepage Report</a> </li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-block">
                                <form method="post" action="@if(isset($record)){{ route('homepagereport-update', array('id' => $record->id)) }}@else{{route('homepagereport-store')}}@endif" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="card-body"> 
                                                ...
                                                <img src="{{asset('uploads/homepagereport/'.$record->image)}}" height="100px" width="100px">
                                            </div>
                                        </div>
                                    </div>
                                    @endif
