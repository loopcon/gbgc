    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-4 col-md-4 col-xl-2 ">
                ...
                <a href="{{route('frontreport')}}" class="btn btn-primary admin-reset-btn">Reset</a>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div style="display: flex; justify-content: center;">
                                    ...
                                    <div class="dt-responsive table-responsive  dashboard-table-responsive  " id="targetDivnew">
