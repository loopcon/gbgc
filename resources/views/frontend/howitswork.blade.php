...
@section('content')
    ...
    <div class="scroll-section-main">
        <div class="container">
            <div class="desktop-view">
                <div class="one clearfix">
                    <div class="left" >
                        <div class="left-child" id="menu-section-scroll">
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step1-create-domain"><span>1 </span> Sign Up</a>
                                <div class="create-your-domain-text">
                                    <a href="#step1-create-domain"><p></p>Create your domain</a>
                                </div>
                                <div class="create-your-domain-text">
                                    <a href="#step2-opt-ingbgc"><p></p>Opt in to content</a>
                                </div>
                            </div>
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step3-invitepeople"><span>2 </span>Invite People</a>
                            </div>
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step4-build-scratch"><span>3 </span>Create Training</a>
                                
                                <div class="create-your-domain-text">
                                    <a href="#step4-build-scratch"><p></p>Build from scratch</a>
                                </div>
                                <div class="create-your-domain-text">
                                    <a href="#step5-use-prebuilt-content"><p></p>Use prebuilt content</a>
                                </div>
                                <div class="create-your-domain-text">
                                    <a href="#step6-importparty-training"><p></p>Import third-party training</a>
                                </div>
                            </div>
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step7-publish-training"><span>4 </span>Publish & Enroll</a>
                            </div>
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step8-discover-learn"><span>5 </span>Discover & Learn</a>
                            </div>
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step9-analyze-impact"><span>6 </span>Analyze</a>
                            </div>
                            <div class="sign-up-text">
                                <a class="signmain-menu" href="#step10-integrations"><span>7 </span>Integrations</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="create-domain-box">
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 57 57">
                                        <g fill="none">
                                            <path fill="#00ACE0" d="M19.7 27.6h16.5c2.6 0 4.7 2.1 4.7 4.7S38.8 37 36.2 37H19.7c-2.6 0-4.7-2.1-4.7-4.7s2.1-4.7 4.7-4.7z"></path>
                            ...
                            <div class="create-domain-box">
                                <div class="create-domain-box-item-1">
                                    <svg fill="none" viewBox="0 0 76 54">
                                        <path fill="#00ACE0" d="M24.443 37.479h-8.63v7.15h8.63v-7.15z"></path>
                                        <path fill="#BFBFBF" d="M36.023 37.479h-8.63v7.15h8.63v-7.15zm11.57 0h-8.63v7.15h8.63v-7.15z"></path>
                                        <path fill="#00ACE0" d="M59.173 37.479h-8.63v7.15h8.63v-7.15zm-34.73-19h-8.63v7.15h8.63v-7.15z"></path>
                                        ...
                                        <path fill="#00ACE0" d="M47.593 27.759h-8.63v7.15h8.63v-7.15z"></path>
                                        ...
                                        <path fill="#00ACE0" d="M64 22.009c6.075 0 11-4.925 11-11 0-6.076-4.925-11-11-11-6.076 0-11 4.924-11 11 0 6.075 4.924 11 11 11z"></path>
                                ...
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 60 53">
                                        <g fill="none"><g transform="translate(4 5)">
                                            ...
                                            <circle cx="44.3" cy="37.6" r="14.8" fill="#00ACE0"></circle>
                                ...
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 71 48">
                                        <g fill="none">
                                            ...
                                            <circle cx="13.1" cy="13.4" r="13" fill="#00ACE0"></circle>
                                        </g>
                                    </svg>
                                </div>
                                <div class="create-domain-box-item-2">
                                ...
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 67 63">
                                        ...
                                        <g fill="none" fill-rule="evenodd">
                                            ...
                                            <path fill="#00ACE0" d="M44.31 12.54l-10.967 6.275V6.263z" mask="url(#howitworks-3_2_svg__b)"></path>
                                            ...
                                            <path fill="#00ACE0" d="M15.916 42.333a6.295 6.295 0 016.296 6.295h-6.296v-6.295z" mask="url(#howitworks-3_2_svg__b)"></path>
                                        </g>
                                    </svg>
                                </div>
                                <div class="create-domain-box-item-2">
                            ...
                            <div class="create-domain-box">
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 67 63">
                                        ...
                                        <circle cx="43.5" cy="43.8" r="7.4" fill="#00ACE0"></circle>
                                ...
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 58 53">
                                        <g fill="none">
                                            ...
                                            <circle cx="42.5" cy="37.3" r="15" fill="#00ACE0"></circle>
                                ...
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 64 59">
                                        <g fill="none">
                                            ...
                                            <circle cx="51.2" cy="13.6" r="12.5" fill="#00ACE0"></circle>
                                ...
                                <div class="create-domain-box-item-1">
                                    <svg viewBox="0 0 63 51">
                                        <g fill="none">
                                            ...
                                            <path fill="#00ACE0" d="M58.9 10.5c-.6 0-1.1-.5-1.1-1.1V5.1h-4.3c-.6 0-1.1-.5-1.1-1.1 0-.6.5-1.1 1.1-1.1h5.4c.6 0 1.1.5 1.1 1.1v5.4c0 .6-.5 1.1-1.1 1.1z"></path>
                                        </g>
                                    </svg>
                                </div>
                                <div class="create-domain-box-item-2">
                    ...
                    <div class="sign-upposi header-color middle-screen-focus">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                <a class="msignmain-menu mobile-hiw-active" href="#step1-mcreate-domain"><span class="mobile-number-bg mobile-numberactive-bg">1 </span> Sign Up </a>
                    ...
                    <div class="sign-upposi header-color">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                ...
                                <a class="msignmain-menu" href="#step3-minvitepeople"><span class="mobile-number-bg mobile-numberactive-bg">2</span> Invite People </a>
                                <a class="msignmain-menu" href="#step4-mbuild-scratch"><span class="mobile-number-bg">3</span> Create Training </a>
                                <a class="msignmain-menu" href="#step7-mpublish-training"><span class="mobile-number-bg">4</span> Publish & Enroll </a>
                                <a class="msignmain-menu" href="#step8-mdiscover-learn"><span class="mobile-number-bg">5</span> Train </a>
                                <a class="msignmain-menu" href="#step9-manalyze-impact"><span class="mobile-number-bg">6</span> Analyze </a>
                    ...
                    <div class="sign-upposi header-color">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                <a class="msignmain-menu step-1mosignmenu" href="#step1-mcreate-domain"><span class="mobile-number-bg">1 </span> Sign Up </a>
                                <a class="msignmain-menu" href="#step3-minvitepeople"><span class="mobile-number-bg">2</span> Invite People </a>
                                <a class="msignmain-menu" href="#step4-mbuild-scratch"><span class="mobile-number-bg mobile-numberactive-bg">3</span> Create Training </a>
                                <a class="msignmain-menu" href="#step7-mpublish-training"><span class="mobile-number-bg">4</span> Publish & Enroll </a>
                                <a class="msignmain-menu" href="#step8-mdiscover-learn"><span class="mobile-number-bg">5</span> Train </a>
                                <a class="msignmain-menu" href="#step9-manalyze-impact"><span class="mobile-number-bg">6</span> Analyze </a>
                                <a class="msignmain-menu" href="#step10-mintegrations"><span class="mobile-number-bg">7</span> Integrations </a>
                    ...
                    <div class="sign-upposi header-color">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                ...
                                <a class="msignmain-menu" href="#step3-minvitepeople"><span class="mobile-number-bg">2</span> Invite People </a>
                                <a class="msignmain-menu" href="#step4-mbuild-scratch"><span class="mobile-number-bg">3</span> Create Training </a>
                                <a class="msignmain-menu" href="#step7-mpublish-training"><span class="mobile-number-bg mobile-numberactive-bg">4</span> Publish & Enroll </a>
                                <a class="msignmain-menu" href="#step8-mdiscover-learn"><span class="mobile-number-bg">5</span> Train </a>
                                <a class="msignmain-menu" href="#step9-manalyze-impact"><span class="mobile-number-bg">6</span> Analyze </a>
                                <a class="msignmain-menu" href="#step10-mintegrations"><span class="mobile-number-bg">7</span> Integrations </a>
                            </div>
                    ...
                    <div class="sign-upposi header-color">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                ...
                                <a class="msignmain-menu" href="#step4-mbuild-scratch"><span class="mobile-number-bg">3</span> Create Training </a>
                                <a class="msignmain-menu" href="#step7-mpublish-training"><span class="mobile-number-bg">4</span> Publish & Enroll </a>
                                <a class="msignmain-menu" href="#step8-mdiscover-learn"><span class="mobile-number-bg mobile-numberactive-bg">5</span> Train </a>
                                <a class="msignmain-menu" href="#step9-manalyze-impact"><span class="mobile-number-bg">6</span> Analyze </a>
                                <a class="msignmain-menu" href="#step10-mintegrations"><span class="mobile-number-bg">7</span> Integrations </a>
                            </div>
                        </div>
                    ...
                    <div class="sign-upposi header-color">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                ...
                                <a class="msignmain-menu" href="#step7-mpublish-training"><span class="mobile-number-bg">4</span> Publish & Enroll </a>
                                <a class="msignmain-menu" href="#step8-mdiscover-learn"><span class="mobile-number-bg">5</span> Train </a>
                                <a class="msignmain-menu" href="#step9-manalyze-impact"><span class="mobile-number-bg mobile-numberactive-bg">6</span> Analyze </a>
                                <a class="msignmain-menu" href="#step10-mintegrations"><span class="mobile-number-bg">7</span> Integrations </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sign-upposi header-color">
                        <div class="msign-up-text">
                            ...
                            <div class="mo-hit-menuclick">
                                ...
                                <a class="msignmain-menu" href="#step8-mdiscover-learn"><span class="mobile-number-bg">5</span> Train </a>
                                <a class="msignmain-menu" href="#step9-manalyze-impact"><span class="mobile-number-bg">6</span> Analyze </a>
                                <a class="msignmain-menu" href="#step10-mintegrations"><span class="mobile-number-bg mobile-numberactive-bg">7</span> Integrations </a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            if (mq.matches) {
                ...
                bottomContent = topContent + sectionHeight - rightHeight - 100;
                ...
                nav.find('#menu-section-scroll a').on('click', function () {
                var $el = $(this)
                    , id = $el.attr('href');
